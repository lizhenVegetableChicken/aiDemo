import os
from youtube_audio_downloader import video_to_audio
...
class YoutubeToText:
    ...
    def process(self, video_id, title):
        """
        处理YouTube视频
        ...
        try:
            ...
            if not video_to_audio(video_url, audio_path):
            ...
            print(f"文本文件：{os.path.join(self.txt_dir, f'{title}_transcript.txt')}")
            return True
...
def main():
    ...
    while True:
        try:
            ...
            if processor.process(video_id, title):
                # 询问是否继续
